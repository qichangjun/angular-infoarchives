...
(function() {
  angular.module("myApp").service("hsAPI", function() {
    this["upload"] = "/upload";
    this["commonUpload"] = "/common/upload";
    this["getUserImg"] = "/user/head_photo";
    this["getUserId"] = "/user/get_by_token";
    this["editCurrentUser"] = "/user/update_user";
    this["userLogout"] = "/user/login_out";
    ...
    this["saveRetentionPeriodAndPolicy"] = "/project/update";
    ...
    this["getOverAll"] = "/statistics/overall";
    this["getYearList"] = "/statistics/year";
    this["getRecordNum"] = "/statistics/unitList";
    this["getBusinessMatterList"] = "/statistics/businessMatterList";
    this["exportExcel"] = "/statistics/export_data";
    this["getTopology"] = "/statistics/topology";
    this["getSystemLists"] = "/statistics/systemNameList";
    this["getDocId"] = "record/getFile";
    this["markMessageStatus"] = "/message/mark_as_read";
    this["getMessageLists"] = "/message/list";
    this["downloadErrorDoc"] = "/message/download";
  });
