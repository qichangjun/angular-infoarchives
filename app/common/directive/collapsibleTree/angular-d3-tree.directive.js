      ...
      link: function(scope, element) {
        $timeout(function() {
          ...
          append_addFileButton = function(editContainer, d) {
            ...
            return editContainer.append('svg:text').attr('x', 155).attr('y', -3).attr('text-anchor', 'middle').attr('class', 'cursor-pointer').text('添加文件').on('click', function(d) {
              scope.$emit('node:addFile', d);
              return window.event.stopPropagation();
            });
          };
          append_editFileButton = function(editContainer, d) {
            if (d.hasFile > 0) {
              ...
              return editContainer.append('svg:text').attr('x', 155).attr('y', 40).attr('id', 'fileNum' + d.code).attr('text-anchor', 'middle').attr('class', 'cursor-pointer').text('文件列表' + '(' + d.hasFile + ')').on('click', function(d) {
                scope.$emit('node:editFile', d);
                return window.event.stopPropagation();
              });
            }
