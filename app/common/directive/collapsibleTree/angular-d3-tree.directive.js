      ...
      link: function(scope, element) {
        $timeout(function() {
          ...
          scope.$on('update:fileNum', function(e, obj, hasFile) {
            return $('#' + 'fileNum' + obj.objectId).text(hasFile);
          });
          update = function(source) {
            ...
            nodeEnter = node.enter().append('svg:g').attr('class', 'node').attr('transform', function(d) {
              ...
              editContainer.append('svg:text').attr('x', 90).attr('y', -20).attr('class', 'cursor-pointer').text(function(d) {
                return '\uf055';
              }).attr("font-family", "FontAwesome").on('click', function(d) {
              ...
              editContainer.append('svg:text').attr('x', 88).attr('y', 5).attr('class', 'cursor-pointer').text(function(d) {
                return '\uf121';
              }).attr("font-family", "FontAwesome").on('click', function(d) {
