(function() {
  ...
  angular.module("myApp").controller("ruleSetController", [
    '$scope', '$log', '$state', '$timeout', '$stateParams', 'ruleSetService', 'dataModuleService', 'mdToastService', 'basicDataService', '$translate', function($scope, $log, $state, $timeout, $stateParams, ruleSetService, dataModuleService, mdToastService, basicDataService, $translate) {
