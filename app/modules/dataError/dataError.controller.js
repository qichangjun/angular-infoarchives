(function() {
  ...
  angular.module("myApp").filter("toDate", function() {
    ...
    '$scope', '$log', '$state', '$timeout', '$element', '$stateParams', 'dataErrorService', 'dataBaseService', 'i18nService', 'hsTpl', function($scope, $log, $state, $timeout, $element, $stateParams, dataErrorService, dataBaseService, i18nService, hsTpl) {
      ...
      getGridData = function() {
        ...
        if (vm.parameter.objectId) {
          return dataErrorService.getGridData(vm.parameter).then(function(res) {
            ...
            $scope.gridOptions.columnDefs = dataErrorService.dataError;
            return $scope.gridOptions.columnVirtualizationThreshold = dataErrorService.dataError.length;
          }, function(res) {});
        }
      };
