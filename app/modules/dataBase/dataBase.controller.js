(function() {
  ...
  angular.module("myApp").controller("dataBaseController", [
    '$scope', '$log', 'dataBaseService', '$stateParams', '$state', 'initGrid', '$timeout', 'dataErrorService', function($scope, $log, dataBaseService, $stateParams, $state, initGrid, $timeout, dataErrorService) {
