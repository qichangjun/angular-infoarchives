(function() {
  'use strict';
  angular.module('myApp', ['ngAnimate', 'ngTouch', 'ngSanitize', 'ui.router', 'pascalprecht.translate', 'restangular', 'ngLocale', 'ngMaterial', 'ui.grid', 'ui.grid.selection', 'ui.grid.edit', 'ui.grid.rowEdit', 'ui.grid.cellNav', 'ui.grid.pagination', 'ui.grid.resizeColumns', 'ui.grid.pinning', 'ui.grid.moveColumns', 'ui.grid.resizeColumns', 'ui.grid.saveState', 'ui.grid.autoResize', 'ui.grid.infiniteScroll', 'ui.bootstrap', 'ngMessages', 'anim-in-out', 'ui.select', 'angular-loading-bar', 'xeditable']).constant('Cookies', Cookies).constant('_', _).constant('Base64', Base64).constant('hsTpl', {}).constant('commonConifg', {}).config([
    '$stateProvider', '$urlRouterProvider', '$locationProvider', '$httpProvider', function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
      ...
      $stateProvider.state("login", {
        ...
        url: "userManage",
        templateUrl: "webComponents/userManage/userManage.html?" + window.hsConfig.bust,
