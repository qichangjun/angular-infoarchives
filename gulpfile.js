...
gulp.task('sass', function () {
    return gulp.src(['app/**/*.scss','!app/vendor/bootstrap-sass-3.3.5/**/*.scss','!app/bower_components/bootstrap-sass/**/*.scss'])
...
gulp.task('less', function () {
    return gulp.src('app/vendor/angular-ui-grid-3.0.7/less/main.less')
        .pipe(sourcemaps.init())
        .pipe(plugins.less())
        .pipe(sourcemaps.write('../maps'))
        .pipe(gulp.dest('app/vendor/angular-ui-grid-3.0.7/less/'));
});
...
gulp.task('html', function () {
    return gulp.src('app/webComponents/**/*.html')
...
gulp.task('images',['favicon','docIcons'], function () {
    return gulp.src(['app/images/*.{png,gif,jpg}','app/webComponents/**/*.{png,gif,jpg}'])
        .pipe(plugins.flatten())
        .pipe(gulp.dest('dist/images'))
});

gulp.task('venderStyle', function () {
    return gulp.src(['app/vendor/zTree_v3/css/zTreeStyle/img/*.{png,gif,jpg,css,eot,svg,ttf,woff,woff2}'])
